...
describe('StepVisionDescriptionView', () => {
  ...
  describe('故事脉络', () => {
    it('所有帧描述非空时应显示故事脉络区块', () => {
      ...
      // storyLineText = "清晨，太阳升起。\n\n人物走进画面。"
      // 在 DOM 中会被渲染为包含换行的文本节点
  ...
  describe('编辑交互', () => {
    it('点击描述文本应触发 onSetEditing(idx, true)', () => {
      ...
      fireEvent.click(screen.getByText('可编辑描述'));
