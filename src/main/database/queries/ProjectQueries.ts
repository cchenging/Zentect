export const PROJECT_SQL = {
  ...
  INSERT_ROLE_FULL: `
    INSERT INTO roles (
      id, project_id, system_id, name, pronoun, avatar, description, voice_id, merged_roles, faces_json, global_character_id, create_time, update_time, is_deleted
    ) VALUES (
      @id, @projectId, @systemId, @name, @pronoun, @avatar, @description, @voiceId, @mergedRoles, @facesJson, @globalCharacterId, datetime('now', 'localtime'), datetime('now', 'localtime'), 0
    )
  `,
  INSERT_SHOT_FULL: `
    INSERT INTO shots (
