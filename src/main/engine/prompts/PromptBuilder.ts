...
7. **👥 多人物强约束（多人物画面最高优先级）**：画面中出现两个及以上可辨识人物时，严格执行以下 3 条
   7.1 ❶ 禁止罗列人物外观穿着/特征：不准写"穿黑西装的男子""戴眼镜的女士""左边白衣青年"等并列描述——直接使用角色姓名或通用人称写动作
   7.2 ❷ 强制输出【A-Verb-B 交互动作】：不准"张三站着/李四坐着"的并列描述，必须写"谁对谁做了什么"（如"张三举枪质问李四""李四递文件给张三"）
   7.3 ❸ 交互短句字数上限：interaction 交互描述控制在 **15 字以内**（短句，禁止啰嗦修饰）`.trim();
  }
  /**
