...
describe('Entity Types', () => {
  ...
  it('PipelineParams', () => { const p = { narrativePerspective:'third', informationLevel:'deep', narrationDensity:'standard', originalAudioStrategy:'keep_key', rhythmMode:'mixed', emotionTone:'neutral', hookIntensity:0.7, audioVisualWeight:0.6 }; expect(p.hookIntensity).toBe(0.7); });
