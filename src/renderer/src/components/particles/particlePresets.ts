...
export const particlePresets: Record<string, ParticlePreset> = {
  dandelion: {
    ...
    // size=半径基准：中心圆 size*0.6，放射线 size*3 → 需足够大才能看出伞状
    sizeRange: [2.5, 4.5],
  ...
  stardust: {
    ...
    // size=光芒长基准：中心圆 size*0.5，光线 size*2.5
    sizeRange: [1.5, 3],
