...
import type { ScriptParagraph, TtsResult } from "../../../../../../../shared/types/entities/editor";

export interface TtsVoiceOption { id: string; name: string; lang: string; }

export interface StepTTSSynthesisProps {
  ttsEngine: string;
  ttsVoiceId: string;
  ttsProgress: number;
...
export const StepTTSSynthesisView: React.FC<StepTTSSynthesisProps> = (props) => {
